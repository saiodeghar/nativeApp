    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="w-full justify-center items-center h-full px-4">
          ...
          <Text className="text-sm font-pregular text-gray-100 mt-7 text-center">Where creativity meets innovation: embarked on a journey of limitless exploration with Aora</Text>
          <CustomButton title="Continue with Email" handlePress={()=>{router.push('/sign_in')}} containerStyles="w-full mt-7"/>
          <CustomButton title="Continue without Email" handlePress={()=>{router.push('/free')}} containerStyles="w-full mt-7"/>
        </View>
      </ScrollView>
